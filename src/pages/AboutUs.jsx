      ...
      <div className="container mx-auto">
        <div className="px-3 lg:px-20 py-10">
          <div className="text-start mt-14 ">
            ...
            <p className="text-xs lg:text-lg xl:text-[16px] text-[#474747] ms-5 lg:ms-8 lg:me-12 my-10">
            ...
            <div className="lg:flex flex-row">
              ...
              <div className="basis-5/12 lg:order-1">
                <p className="text-xs lg:text-lg xl:text-[16px] text-[#474747] ms-5 lg:ms-8 lg:me-12">
