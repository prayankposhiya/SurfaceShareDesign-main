...
import Img1 from "../assets/Images/t&p.png";
...
export default function TermsPolicy() {
  return (
    <div className={``}>
      <div className="bg-[#FCF0C6] h-5/6">
        <div className="container mx-auto">
          <div className="pt-16 h-full">
            <h2 className="text-6xl text-[#323031] font-semibold  text-start">Terms & Policy</h2>
      ...
      <div className="container mx-auto">
        <div className="my-24">
          <h4 className="text-3xl text-[#323031] font-semibold my-10">Terms & Policy</h4>
