      ...
      >
        <div className="lg:basis-5/12">
          <div className="text-start xl:mt-14">
            ...
            <p className="my-3 xl:my-5 text-xs lg:text-lg xl:text-xl text-[#474747] font-bold ms-3 xl:ms-8 xl:me-12">
              {cardSubTitle}
            </p>
            <p className=" text-xs lg:text-lg xl:text-[16px] text-[#474747] ms-3 xl:ms-8 xl:me-12 mb-8 lg:mb-0">
              {cardCont}
            </p>
          </div>
        </div>
